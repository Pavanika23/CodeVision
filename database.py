...
stud_menu_img = open('images/student_menu.jpg', 'rb').read()
            ...
            if mymachine.allotment_done== True:
                ...
                with open("datasheet.csv",'r') as f:
                    ...
                    with use_scope("main", clear=True):
                        ...
                        input('KCET Marks', name='marks', type=NUMBER, required=True, help_text="Enter score out of 180.",validate=check_cet),
                        file_upload(label="Marks card", accept=".pdf", name='cet_score_file',max_size='10M', placeholder="choose a file")
                        ],)
